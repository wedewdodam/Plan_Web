...
{
    public partial class Repair_Plan_Details
    {
        ...
        public double AllCost1 { get; private set; }
        public double PartCost1 { get; private set; }
        public double AllCost2 { get; private set; }
        public double PartCost2 { get; private set; }
        public double AllCost3 { get; private set; }
        public double PartCost3 { get; private set; }
        public double AllCost4 { get; private set; }
        public double PartCost4 { get; private set; }
        public double AllCost5 { get; private set; }
        public double PartCost5 { get; private set; }
        public double AllCost6 { get; private set; }
        public double PartCost6 { get; private set; }
        ...
        private async Task DetailsView()
        {
            ...
            AllCost1 = await cost_Lib.Sort_total_All_cost(Apt_Code, strCode, "3");
            PartCost1 = await cost_Lib.Sort_total_Part_cost(Apt_Code, strCode, "3");
            AllCost2 = await cost_Lib.Sort_total_All_cost(Apt_Code, strCode, "4");
            PartCost2 = await cost_Lib.Sort_total_Part_cost(Apt_Code, strCode, "4");
            AllCost3 = await cost_Lib.Sort_total_All_cost(Apt_Code, strCode, "5");
            PartCost3 = await cost_Lib.Sort_total_Part_cost(Apt_Code, strCode, "5");
            AllCost4 = await cost_Lib.Sort_total_All_cost(Apt_Code, strCode, "6");
            PartCost4 = await cost_Lib.Sort_total_Part_cost(Apt_Code, strCode, "6");
            AllCost5 = await cost_Lib.Sort_total_All_cost(Apt_Code, strCode, "7");
            PartCost5 = await cost_Lib.Sort_total_Part_cost(Apt_Code, strCode, "7");
            AllCost6 = await cost_Lib.Sort_total_All_cost(Apt_Code, strCode, "8");
            PartCost6 = await cost_Lib.Sort_total_Part_cost(Apt_Code, strCode, "8");
        }
