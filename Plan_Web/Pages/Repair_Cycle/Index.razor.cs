...
namespace Plan_Web.Pages.Repair_Cycle
{
    public partial class Index
    {
        ...
        private async Task OnCycleAllInsert(string ArticleCode, string ArticleName, string SortCode)
        {
            ...
            string strAgo_plan_code = await repair_Plan_Lib.BeComplete_Code(Apt_Code);
            ...
            if (intArticle > 0)
            {
                ...
                {
                    int now_year = DateTime.Now.Year;
                    if (cnn.Repair_Plan_Year_All >= now_year || cnn.Repair_Plan_Year_All == 0)
                    {
                        if (cnn.Repair_Plan_Year_Part >= now_year || cnn.Repair_Plan_Year_Part == 0)
                        {
